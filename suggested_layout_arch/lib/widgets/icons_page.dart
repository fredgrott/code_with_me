...
class IconsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PlatformScaffold(
      ...
      appBar: PlatformAppBar(title: const Text('Platform Icons')),
      body: Column(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  _IconCompared(
                    'accountCircle',
                    (c) => c.platformIcons.accountCircle,
                  ),
                  _IconCompared(
                    'accountCircleSolid',
                  ...
                  _IconCompared(
                    'batteryEmpty',
                    (c) => c.platformIcons.batteryEmpty,
                  ),
                  _IconCompared(
                    'batteryFull',
                    (c) => c.platformIcons.batteryFull,
                  ),
                  ...
                  _IconCompared(
                    'bookmarkSolid',
                    (c) => c.platformIcons.bookmarkSolid,
                  ),
                  _IconCompared(
                    'brightness',
                    (c) => c.platformIcons.brightness,
                  ),
                  _IconCompared(
                    'brightnessSolid',
                  ...
                  _IconCompared(
                    ...
                    (c) => c.platformIcons.checkBoxIndeterminateOutlineRounded,
                  ),
                  _IconCompared(
                  ...
                  _IconCompared(
                    'clockSolid',
                    (c) => c.platformIcons.clockSolid,
                  ),
                  _IconCompared(
                    'cloud',
                    (c) => c.platformIcons.cloud,
                  ),
                  _IconCompared(
                    'cloudSolid',
                    (c) => c.platformIcons.cloudSolid,
                  ),
                  _IconCompared(
                    'collections',
                    (c) => c.platformIcons.collections,
                  ),
                  _IconCompared(
                    'collectionsSolid',
                  ...
                  _IconCompared(
                    'deleteSolid',
                    (c) => c.platformIcons.deleteSolid,
                  ),
                  _IconCompared(
                    'deleteOutline',
                    (c) => c.platformIcons.deleteOutline,
                  ),
                  ...
                  _IconCompared(
                    'eyeSlashSolid',
                    (c) => c.platformIcons.eyeSlashSolid,
                  ),
                  _IconCompared('eyeSolid', (c) => c.platformIcons.eyeSolid),
                  _IconCompared(
                    'favoriteSolid',
                    (c) => c.platformIcons.favoriteSolid,
                  ),
                  _IconCompared(
                    'favoriteOutline',
                  ...
                  _IconCompared(
                    'folderOpen',
                    (c) => c.platformIcons.folderOpen,
                  ),
                  _IconCompared(
                    'folderSolid',
                    (c) => c.platformIcons.folderSolid,
                  ),
                  _IconCompared('forward', (c) => c.platformIcons.forward),
                  _IconCompared(
                    'fullscreen',
                    (c) => c.platformIcons.fullscreen,
                  ),
                  _IconCompared(
                    'fullscreenExit',
                    (c) => c.platformIcons.fullscreenExit,
                  ),
                  _IconCompared(
                    'gameController',
                    (c) => c.platformIcons.gameController,
                  ),
                  _IconCompared(
                    'gameControllerSolid',
                  ...
                  _IconCompared(
                    'groupSolid',
                    (c) => c.platformIcons.groupSolid,
                  ),
                  _IconCompared(
                    'heartSolid',
                    (c) => c.platformIcons.heartSolid,
                  ),
                  _IconCompared(
                    'help',
                    (c) => c.platformIcons.help,
                  ),
                  _IconCompared(
                    'helpOutline',
                    (c) => c.platformIcons.helpOutline,
                  ),
                  _IconCompared('home', (c) => c.platformIcons.home),
                  _IconCompared('info', (c) => c.platformIcons.info),
                  _IconCompared(
                    'leftChevron',
                    (c) => c.platformIcons.leftChevron,
                  ),
                  _IconCompared('location', (c) => c.platformIcons.location),
                  _IconCompared(
                    'locationSolid',
                    (c) => c.platformIcons.locationSolid,
                  ),
                  ...
                  _IconCompared(
                    'padlockOutline',
                    (c) => c.platformIcons.padlockOutline,
                  ),
                  _IconCompared(
                    'padlockSolid',
                    (c) => c.platformIcons.padlockSolid,
                  ),
                  ...
                  _IconCompared(
                    'personAddSolid',
                    (c) => c.platformIcons.personAddSolid,
                  ),
                  _IconCompared(
                    'personOutline',
                    (c) => c.platformIcons.personOutline,
                  ),
                  _IconCompared(
                    'personSolid',
                    (c) => c.platformIcons.personSolid,
                  ),
                  _IconCompared('phone', (c) => c.platformIcons.phone),
                  _IconCompared(
                    'phoneSolid',
                    (c) => c.platformIcons.phoneSolid,
                  ),
                  _IconCompared(
                    'photoCamera',
                    (c) => c.platformIcons.photoCamera,
                  ),
                  _IconCompared(
                    'photoCameraSolid',
                  ...
                  _IconCompared(
                    'photoLibrary',
                    (c) => c.platformIcons.photoLibrary,
                  ),
                  _IconCompared(
                    'photoLibrarySolid',
                  ...
                  _IconCompared(
                    'playArrowSolid',
                    (c) => c.platformIcons.playArrowSolid,
                  ),
                  _IconCompared('refresh', (c) => c.platformIcons.refresh),
                  _IconCompared(
                    'refreshBold',
                    (c) => c.platformIcons.refreshBold,
                  ),
                  _IconCompared('remove', (c) => c.platformIcons.remove),
                  _IconCompared(
                    'removeCircled',
                    (c) => c.platformIcons.removeCircled,
                  ),
                  _IconCompared(
                    'removeCircledOutline',
                  ...
                  _IconCompared(
                    'switchCamera',
                    (c) => c.platformIcons.switchCamera,
                  ),
                  _IconCompared(
                    'switchCameraSolid',
                  ...
                  _IconCompared(
                    'volumeDown',
                    (c) => c.platformIcons.volumeDown,
                  ),
                  _IconCompared(
                    'volumeMute',
                    (c) => c.platformIcons.volumeMute,
                  ),
